<h2><a href="https://www.geeksforgeeks.org/problems/palindrome-string0817/1?page=2&difficulty=Basic,Easy&sortBy=submissions">Palindrome String</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a string <strong>S</strong>, check if it is palindrome or not.</span></p>

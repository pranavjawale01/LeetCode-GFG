<h2><a href="https://www.geeksforgeeks.org/problems/max-level-sum-in-binary-tree--170647/1?page=1&category=Dynamic%20Programming,Binary%20Search&status=unsolved&sortBy=accuracy">Max Level Sum in Binary Tree</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a Binary Tree having positive and negative nodes. Find the maximum sum of a level in the given Binary Tree.</span></p>

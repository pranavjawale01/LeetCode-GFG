<h2><a href="https://www.geeksforgeeks.org/problems/merge-two-bst-s/1?page=1&difficulty=Hard&status=unsolved&sortBy=accuracy">Merge two BST 's</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given two BSTs, return elements of both BSTs in <strong>sorted </strong>form.</span></p>

<h2><a href="https://www.geeksforgeeks.org/problems/odd-or-even3618/1?page=1&category=Bit%20Magic&sortBy=submissions">Odd or Even</a></h2><h3>Difficulty Level : Difficulty: School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a positive integer N, determine whether it is odd or even.</span></p>

<h2><a href="https://www.geeksforgeeks.org/problems/sum-tree/1?page=2&difficulty=Medium&status=unsolved&sortBy=submissions">Sum Tree</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><div class="entry-content">
